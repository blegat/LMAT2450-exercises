...
\begin{solution}
  ...
  The lask block (encrypthing $r$) is not really interresting as we've already retrieved 
  the messages. The solution to protect the sceem is to put the $r$ block at first.
